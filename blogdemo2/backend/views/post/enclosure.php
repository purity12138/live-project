	...
	<div class="col-md-3">
			<div class="searchbox">
				<ul class="list-group">
				  ...
				  <span class="glyphicon glyphicon-search" aria-hidden="true"></span> 输入添加附件的文章id
				  </li>
				  <li class="list-group-item">				  
				  <form action="upload.php" method="post" enctype="multipart/form-data">
				  <div class="form-group">
						    <input type="text" class="form-control" name="text" id="w0input" placeholder="文章id">
